          ...
          <div className='appbar-search'>
            <form>
              <div className='input-group dark:bg-gray-700 bg-gray-300 rounded-xl h-11 min-w-80 flex py-1 px-3 relative'>
                ...
                <input type="text" placeholder='Search here ...' className='input-control border-none outline-0 text-[15px] dark:bg-gray-700 bg-gray-300 px-3 dark:text-white text-gray-950 dark:placeholder-white placeholder-gray-800' />
              </div>
            </form>
          </div>
          <AppbarLang />
